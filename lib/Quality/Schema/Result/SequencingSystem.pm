use utf8;
package Quality::Schema::Result::SequencingSystem;
...
Related object: L<Quality::Schema::Result::Quality>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:fm/TwrDjePwsP/dVaOoTAQ
