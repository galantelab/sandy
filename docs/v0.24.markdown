...
1. To see a brief help for **Sandy**, you can type:
    ```bash
    $ sandy help
    ```
or
    ...
    $ sandy -h
    ```
2. To see a brief help for the `expression` command, you can type:
    ```bash
...
To take a BibTeX entry to cite *Sandy*, type:
    ```bash
    $ sandy citation
    ```
